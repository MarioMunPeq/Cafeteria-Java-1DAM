...
public class Ventana_otra_bebida extends javax.swing.JFrame {
    ...
    public Ventana_otra_bebida() {
        ...
        // agua con gas C:\Users\admin\Desktop\OneDrive -
        // Educacyl\PROGRAMACION\proyecto_cafe_probar\src\cafeteria_imagenes_botones\125x90\agua
        // gas.png
        ImageIcon img_gas = new ImageIcon("img\\cafeteria_imagenes_botones\\125x90\\agua gas.png");
        ...
        Image im_gas = img_gas.getImage().getScaledInstance(jb_agua_gas.getWidth(), jb_agua_gas.getHeight(),
                Image.SCALE_SMOOTH);
        jb_agua_gas.setIcon(new ImageIcon(im_gas));
        // agua
        ImageIcon img_agua = new ImageIcon("img\\cafeteria_imagenes_botones\\125x90\\agua.png");
        Image im_agua = img_agua.getImage().getScaledInstance(jb_agua.getWidth(), jb_agua.getHeight(),
                Image.SCALE_SMOOTH);
        jb_agua.setIcon(new ImageIcon(im_agua));
        // aquarius
        ImageIcon img_aquarios = new ImageIcon("img\\cafeteria_imagenes_botones\\125x90\\aquarius.png");
        Image im_aquarius = img_aquarios.getImage().getScaledInstance(jb_acuarius.getWidth(), jb_acuarius.getHeight(),
                Image.SCALE_SMOOTH);
        jb_acuarius.setIcon(new ImageIcon(im_aquarius));
        // vino blanco
        ImageIcon img_blanco = new ImageIcon("img\\cafeteria_imagenes_botones\\125x90\\blanco.png");
        Image im_blanco = img_blanco.getImage().getScaledInstance(jb_blanco.getWidth(), jb_blanco.getHeight(),
                Image.SCALE_SMOOTH);
        jb_blanco.setIcon(new ImageIcon(im_blanco));
        // caña
        ImageIcon img_cania = new ImageIcon("img\\cafeteria_imagenes_botones\\125x90\\caña.png");
        Image im_cania = img_cania.getImage().getScaledInstance(jb_cania.getWidth(), jb_cania.getHeight(),
                Image.SCALE_SMOOTH);
        jb_cania.setIcon(new ImageIcon(im_cania));
        // cañon
        ImageIcon img_canion = new ImageIcon("img\\cafeteria_imagenes_botones\\125x90\\cañon.png");
        Image im_canion = img_canion.getImage().getScaledInstance(jb_canion.getWidth(), jb_canion.getHeight(),
                Image.SCALE_SMOOTH);
        jb_canion.setIcon(new ImageIcon(im_canion));
        // coca cola
        ImageIcon img_cola = new ImageIcon("img\\cafeteria_imagenes_botones\\125x90\\cola.png");
        Image im_cola = img_cola.getImage().getScaledInstance(jb_cocacola.getWidth(), jb_cocacola.getHeight(),
                Image.SCALE_SMOOTH);
        jb_cocacola.setIcon(new ImageIcon(im_cola));
        // corto de cerveza
        ImageIcon img_corto = new ImageIcon("img\\cafeteria_imagenes_botones\\125x90\\corto.png");
        Image im_corto = img_corto.getImage().getScaledInstance(jb_corto.getWidth(), jb_corto.getHeight(),
                Image.SCALE_SMOOTH);
        jb_corto.setIcon(new ImageIcon(im_corto));
        // fanta limon
        ImageIcon img_limon = new ImageIcon("img\\cafeteria_imagenes_botones\\125x90\\fanta limon.png");
        Image im_limon = img_limon.getImage().getScaledInstance(jb_f_limon.getWidth(), jb_f_limon.getHeight(),
                Image.SCALE_SMOOTH);
        jb_f_limon.setIcon(new ImageIcon(im_limon));
        // fanta naranja
        ImageIcon img_naranja = new ImageIcon("img\\cafeteria_imagenes_botones\\125x90\\fanta naranja.png");
        Image im_naranja = img_naranja.getImage().getScaledInstance(jb_f_naranja.getWidth(), jb_f_naranja.getHeight(),
                Image.SCALE_SMOOTH);
        jb_f_naranja.setIcon(new ImageIcon(im_naranja));
        // matini
        ImageIcon img_martini = new ImageIcon("img\\cafeteria_imagenes_botones\\125x90\\martini.png");
        Image im_martini = img_martini.getImage().getScaledInstance(jb_martini.getWidth(), jb_martini.getHeight(),
                Image.SCALE_SMOOTH);
        jb_martini.setIcon(new ImageIcon(im_martini));
        // nestea
        ImageIcon img_nestea = new ImageIcon("img\\cafeteria_imagenes_botones\\125x90\\nestea.png");
        Image im_nestea = img_nestea.getImage().getScaledInstance(jb_nestea.getWidth(), jb_nestea.getHeight(),
                Image.SCALE_SMOOTH);
        jb_nestea.setIcon(new ImageIcon(im_nestea));
        // vino rosado
        ImageIcon img_rosado = new ImageIcon("img\\cafeteria_imagenes_botones\\125x90\\rosado.png");
        Image im_rosado = img_rosado.getImage().getScaledInstance(jb_rosado.getWidth(), jb_rosado.getHeight(),
                Image.SCALE_SMOOTH);
        jb_rosado.setIcon(new ImageIcon(im_rosado));
        // sprite
        ImageIcon img_sprite = new ImageIcon("img\\cafeteria_imagenes_botones\\125x90\\sprite.png");
        Image im_sprite = img_sprite.getImage().getScaledInstance(jb_sprite.getWidth(), jb_sprite.getHeight(),
                Image.SCALE_SMOOTH);
        jb_sprite.setIcon(new ImageIcon(im_sprite));
        // vino tinto
        ImageIcon img_tinto = new ImageIcon("img\\cafeteria_imagenes_botones\\125x90\\tinto.png");
        Image im_tinto = img_tinto.getImage().getScaledInstance(jb_tinto.getWidth(), jb_tinto.getHeight(),
                Image.SCALE_SMOOTH);
                ...
                jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                .addComponent(jb_acuarius, javax.swing.GroupLayout.PREFERRED_SIZE, 125,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                                .addComponent(jb_sprite, javax.swing.GroupLayout.PREFERRED_SIZE, 125,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                                .addComponent(jb_nestea, javax.swing.GroupLayout.PREFERRED_SIZE, 125,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                .addComponent(jb_cocacola, javax.swing.GroupLayout.PREFERRED_SIZE, 125,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                                .addComponent(jb_f_naranja, javax.swing.GroupLayout.PREFERRED_SIZE, 125,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                                .addComponent(jb_f_limon, javax.swing.GroupLayout.PREFERRED_SIZE, 125,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                .addComponent(jb_agua, javax.swing.GroupLayout.PREFERRED_SIZE, 125,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                                .addComponent(jb_agua_gas, javax.swing.GroupLayout.PREFERRED_SIZE, 125,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                                .addComponent(jb_martini, javax.swing.GroupLayout.PREFERRED_SIZE, 125,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                .addGroup(jPanel2Layout
                                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                                .addComponent(jb_corto,
                                                                        javax.swing.GroupLayout.PREFERRED_SIZE, 125,
                                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                .addPreferredGap(
                                                                        javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                                                .addComponent(jb_cania,
                                                                        javax.swing.GroupLayout.PREFERRED_SIZE, 125,
                                                                        javax.swing.GroupLayout.PREFERRED_SIZE))
                                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                                .addComponent(jb_blanco,
                                                                        javax.swing.GroupLayout.PREFERRED_SIZE, 125,
                                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                                .addPreferredGap(
                                                                        javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                                                .addComponent(jb_rosado,
                                                                        javax.swing.GroupLayout.PREFERRED_SIZE, 125,
                                                                        javax.swing.GroupLayout.PREFERRED_SIZE)))
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                                .addGroup(jPanel2Layout
                                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                        .addComponent(jb_tinto, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                125, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                        .addComponent(jb_canion, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                125, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        jPanel2Layout.setVerticalGroup(
                jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGap(10, 10, 10)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(jb_cocacola, javax.swing.GroupLayout.PREFERRED_SIZE, 90,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGroup(jPanel2Layout
                                                .createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                                .addComponent(jb_f_naranja, javax.swing.GroupLayout.PREFERRED_SIZE, 90,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addComponent(jb_f_limon, javax.swing.GroupLayout.PREFERRED_SIZE, 90,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(jb_acuarius, javax.swing.GroupLayout.PREFERRED_SIZE, 90,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jb_sprite, javax.swing.GroupLayout.PREFERRED_SIZE, 90,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jb_nestea, javax.swing.GroupLayout.PREFERRED_SIZE, 90,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(jb_agua, javax.swing.GroupLayout.PREFERRED_SIZE, 90,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jb_agua_gas, javax.swing.GroupLayout.PREFERRED_SIZE, 90,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jb_martini, javax.swing.GroupLayout.PREFERRED_SIZE, 90,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(jb_corto, javax.swing.GroupLayout.PREFERRED_SIZE, 90,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jb_cania, javax.swing.GroupLayout.PREFERRED_SIZE, 90,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jb_canion, javax.swing.GroupLayout.PREFERRED_SIZE, 90,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(jb_blanco, javax.swing.GroupLayout.PREFERRED_SIZE, 90,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jb_tinto, javax.swing.GroupLayout.PREFERRED_SIZE, 90,
                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jb_rosado, javax.swing.GroupLayout.PREFERRED_SIZE, 90,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jb_f_naranjaActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jb_f_naranjaActionPerformed
        ...
        Main_botones.productosAuxiliar.add(Main_botones.productosBBDD.get(21));
    ...
    private void jb_aguaActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jb_aguaActionPerformed
        ...
        Main_botones.productosAuxiliar.add(Main_botones.productosBBDD.get(27));
    ...
    private void jb_spriteActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jb_spriteActionPerformed
        ...
        Main_botones.productosAuxiliar.add(Main_botones.productosBBDD.get(24));
    ...
    private void jb_cocacolaActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jb_cocacolaActionPerformed
        ...
        Main_botones.productosAuxiliar.add(Main_botones.productosBBDD.get(20));
    ...
    private void jb_acuariusActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jb_acuariusActionPerformed
        ...
        Main_botones.productosAuxiliar.add(Main_botones.productosBBDD.get(23));
    ...
    private void jb_tintoActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jb_tintoActionPerformed
        ...
        Main_botones.productosAuxiliar.add(Main_botones.productosBBDD.get(31));
    ...
    private void jb_agua_gasActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jb_agua_gasActionPerformed
        ...
        Main_botones.productosAuxiliar.add(Main_botones.productosBBDD.get(26));
    ...
    private void jb_cortoActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jb_cortoActionPerformed
        ...
        Main_botones.productosAuxiliar.add(Main_botones.productosBBDD.get(29));
    ...
    private void jb_nesteaActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jb_nesteaActionPerformed
        ...
        Main_botones.productosAuxiliar.add(Main_botones.productosBBDD.get(25));
    ...
    private void jb_f_limonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jb_f_limonActionPerformed
        ...
        Main_botones.productosAuxiliar.add(Main_botones.productosBBDD.get(22));
    ...
    private void jb_canionActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jb_canionActionPerformed
        ...
        Main_botones.productosAuxiliar.add(Main_botones.productosBBDD.get(30));
    ...
    private void jb_martiniActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jb_martiniActionPerformed
        ...
        Main_botones.productosAuxiliar.add(Main_botones.productosBBDD.get(34));
    ...
    private void jb_blancoActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jb_blancoActionPerformed
        ...
        Main_botones.productosAuxiliar.add(Main_botones.productosBBDD.get(32));
    ...
    private void jb_caniaActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jb_caniaActionPerformed
        ...
        Main_botones.productosAuxiliar.add(Main_botones.productosBBDD.get(28));
    ...
    private void jb_rosadoActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jb_rosadoActionPerformed
        ...
        Main_botones.productosAuxiliar.add(Main_botones.productosBBDD.get(33));
    ...
    private void jb_aniadir_ticket_iotras_bebidasActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jb_aniadir_ticket_iotras_bebidasActionPerformed
        ...
        jta_info_add_ticket_otras_bebidas.setText("");
